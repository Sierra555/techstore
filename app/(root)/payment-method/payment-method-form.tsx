...
const PaymentMethodForm = ({ prefferedPaymentMethod }:
                ...
                <FormControl>
                  ...
                  >
                     {PAYMENT_METHODS.map((paymentMethod) => (
                      <FormItem className='flex items-center space-x-3 space-y-0' key={paymentMethod}>
                        <FormControl>
                          <RadioGroupItem value={paymentMethod} checked={field.value === paymentMethod} />
                        </FormControl>
                        <FormLabel className="fonr-normal">
                          {paymentMethod}
                        </FormLabel>
                      </FormItem>
                    ))}
