...
const DealCountdown = () => {
  ...
  useEffect(() => {
    setTime(calculateRemainingTime(TARGET_DATE));

    const interval = setInterval(() => {
      const newTime = calculateRemainingTime(TARGET_DATE);
    ...
    return (
      <section className="grid grid-cols-1 md:grid-cols-2 my-20">
        ...
        <div className='flex justify-center'>
          <Image
            src='/images/public/images/products/11-inch-ipad-pro-512gb-space-gray.png'
            alt='promotion'
            width={300}
            height={200}
          />
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 my-20">
      ...
      <div className='flex justify-center'>
        <Image
          src='/images/products/11-inch-ipad-pro-512gb-space-gray.png'
          alt='promotion'
          width={300}
          height={200}
        />
